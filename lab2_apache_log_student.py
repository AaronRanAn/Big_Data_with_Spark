...
dayToHostUnique = dayGroupedHosts.map(lambda (a,b):(a[0],1))

dayHostCount = dayToHostUnique.reduceByKey(lambda a,b:a+b)
...
print dailyHosts.collect() # I add this line to check the different RDD content
...
print daysWithHosts  # I add these two line for reference to print value
...
# print badEndpoints.first()

badUniqueEndpoints = badEndpoints.distinct()

# print badUniqueEndpoints.first()
...
# print errDateSum.collect()

errDateSorted = (errDateSum.sortByKey())

# print errDateSorted.collect()

errByDate = (errDateSorted.cache().collect()) # cache first and collect to convert to LIST
...
# print badRecords.take(10) or .first()

hourCountPairTuple = badRecords.map(lambda log:(log.date_time.hour,1))

hourRecordsSum = hourCountPairTuple.reduceByKey(lambda a, b: a + b).distinct()
